...
mod tests {
    ...
    fn new_parses_valid_manifest() {
        ...
        assert_eq!(insights.header.project_url, "https://github.com/ossf/security-insights-spec");
        ...
        assert!(insights.vulnerability_reporting.accepts_vulnerability_reports);
