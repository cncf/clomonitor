...
const ElementWithTooltip = (props: Props) => {
  ...
  return (
    <WrapperElement className={`d-none d-md-block position-relative ${props.className}`}>
      <div
        ref={wrapper}
      ...
      {props.visibleTooltip && visibleTooltipStatus && (
        ...
        >
          <div
            className={`tooltip show bs-tooltip-bottom ${styles.tooltip} ${props.tooltipClassName}`}
            role="tooltip"
