insert into foundation (foundation_id, display_name, data_url, landscape_url)
values ('cncf', 'CNCF', 'https://raw.githubusercontent.com/cncf/clomonitor/main/data/cncf.yaml', 'https://raw.githubusercontent.com/cncf/landscape/master/landscape.yml');
